...
export default function Dashboard() {
  ...
  return <div className="min-h-screen bg-gray-50">
    ...
    <main className="max-w-7xl mx-auto py-8 px-4">
      ...
      <section className="mt-8 bg-white rounded-lg border p-6"><h2 className="text-xl font-bold mb-4">Quick Actions</h2><div className="grid grid-cols-1 md:grid-cols-3 gap-4"><ActionButton to="/master-data" label="Customers & Products" /><ActionButton to="/purchases" label="Purchases & Suppliers" /><ActionButton to="/inventory" label="Inventory & Batches" /><ActionButton to="/sales" label="Create Invoice" /><ActionButton to="/returns" label="Sales & Purchase Returns" /><ActionButton to="/receivables" label="Receivables & Payments" /><ActionButton to="/accounting" label="Accounting, Payables & GST" /><ActionButton to="/expiry" label="Expiry Management" /></div></section>
    </main></div>
}
